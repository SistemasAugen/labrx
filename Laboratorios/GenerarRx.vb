...
Public Class GenerarRx
    ...
    Public Function GetMoldeDerInfo() As Calcot.ReturnMoldeDer
        ...
        Else
            ...
            'MsgBox("Su Generador de Forma libre no manda información completa del anillo." + vbCrLf + "Actualize su guiador", MsgBoxStyle.Information, "Optisur.LendsDsgRight.ringSurf.BlockCurve")
        End If
    ...
    Public Function GetMoldeIzqInfo() As Calcot.ReturnMoldeIzq
        ...
        Else
            'MsgBox("Su Generador de Forma libre no manda información completa del anillo." + vbCrLf + "Actualize su guiador", MsgBoxStyle.Information, "Optisur.LendsDsgLeft.ringSurf.BlockCurve")
            Beep()
        End If
        ...
        Try
            ...
            If My.Settings.OpticalProtocol = "OMA" Then
                ...
                If RadiosR(0) = RadiosR(1) And RadiosR(1) = RadiosR(2) And RadiosR(0) = 0 Then
                    ' No traemos información del trazo derecho, por lo cual la obtenemos al hacer reflejo del lado Izquierdo
