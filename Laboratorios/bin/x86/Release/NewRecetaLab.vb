...
Public Class NewRecetaLab
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laboratorios.NewRecetaLab.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNewRecetaLab
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NewRecetaLab = New NewRecetaLab()
        rpt.Site = Me.Site
        Return rpt
    End Function
